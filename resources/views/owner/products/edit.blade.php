              ...
              <div class="p-6 bg-white border-b border-gray-200">
                <form method="post" action="{{ route('owner.products.update',['product' => $product->id ]) }}" >
                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for=currend_quantity" class="leading-7 text-sm text-gray-600">現在の在庫 ※必須</label>
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                        <label for="shop_id" id="shop_id" class="leading-7 text-sm text-gray-600">販売する店舗</label>
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                              <div class="relative flex justify-around">
                                  ...
                                  <div><input type="radio" name="is_selling" value="0" class="mr-2" @if($product->is_selling === 0) @endif >停止中</div>
                              </div>
                          </div>
                  ...
                  <form id="delete_{{$product->id}}" method="post" action="{{ route('owner.products.destroy',['product' => $product->id ])}}">
                      @csrf
                      @method('delete')
                      <div class="p-2 flex justify-around  mt-32 mb-" > 
                              <a href="#" data-id="{{$product->id}}"  onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2  focus:outline-none hover:bg-red-600 rounded ">削除する</button>
                      </div>
                  </form>
              </div>
          </div>
