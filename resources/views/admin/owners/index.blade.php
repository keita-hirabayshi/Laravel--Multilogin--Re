                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container md:px-5 mx-auto">
                            ...
                            <div onclick="location.href='{{ route('admin.owners.create')}}'" class="flex justify-end mb-4">
                                <button class="text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録する</button>
                            </div>
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr>
                                    ...
                                    <form id="delete_{{$owner->id}}" method="post" action="{{ route('admin.owners.destroy',['owner' => $owner->id ])}}">
                                        ...
                                        @method('delete')
                                        <td class="md:px-4 py-3">
                                            <a href="#" data-id="{{$owner->id}}"  onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded ">削除</button>
                                        </td>
                                    </form>
                                </tr>    
                                @endforeach
